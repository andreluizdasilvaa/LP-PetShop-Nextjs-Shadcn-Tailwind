...
export default function Hero() {
    return (
        <section className="bg-[#E84C3D] text-white relative overflow-hidden">
            ...
            <div className='container mx-auto pt-24 pb-0 px-4 relative'>

                <article className="grid grid-cols-1 lg:grid-cols-2 gap-8">

                    <div className='space-y-6'>
                        <h1 className="text-3xl font-bold md:text-4xl lg:text-5xl leading-10" data-aos="zoom-out-right" data-aos-delay="100">
                            Seu pet merece cuidado, carinho e atenção especial
                        </h1>

                        <p className="lg:text-lg" data-aos="zoom-out-right" data-aos-delay="100">
                            ...
                            <a 
                                ...
                                data-aos="zoom-out-right" data-aos-delay="150"
                            >
                                <WhatsappLogo className="w-5 h-5"/>
                                Contato via Whatsapp
                            </a>

                        <div className="mt-8" data-aos="zoom-out-right" data-aos-delay="100">
